...
* [David Jekel](https://davidjekel.com/) and [Jonathan Shi](https://jshi.science/) to design spectral algorithms that optimize spin glasses, operator-valued polynomials & CSPs, and analyze Gaussian processes on symmetric domains (such as compact Lie groups). We also design sum-of-squares hierarchies to certify algorithmic thresholds for random optimization.
