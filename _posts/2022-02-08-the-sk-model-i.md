...
[^3]: In [this]() upcoming post, various results from the so-called "Gaussian Toolbox" will be stated and briefly proved. This is a very useful set of techniques to have command over to prove properties about mean-fielf spin glasses and relate them to the behavior of random instances of sparse CSPs.  
