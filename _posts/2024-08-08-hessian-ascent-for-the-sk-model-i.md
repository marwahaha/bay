...
This work might seem somewhat opaque and technical to the broader TCS (and even probabilist) audience, so I have decided to write, wtih guest contributions from Jonathan, a **3-part** blog post explaining the background, motivation, proof structure and main technical innovations of this result, as well as its relationships to other works in the literature and the open questions it naturally induces.
